        ...
        <div className="team">
            ...
            <div className="team-bios">
                <div className="one-bio">
                    ...
                    <p classname="bio-text">Sophia is a front-end engineer who is passionate about social justice and creating space for healing and connection. She has a background in mental health advocacy and is extremely determined to make sustainable foods accessible and affordable. What cultivates a community more than putting our hands in the earth? </p>
                </div>
                <div className="one-bio">
